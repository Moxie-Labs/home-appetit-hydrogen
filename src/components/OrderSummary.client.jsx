        ...
        return (
            <section className="order-summary--enlarged-items">
                ...
                <section className="order-summary--items main-items">
                    <h4 className="bold">{getQuantityTotal(selectedMainItems)} { activeScheme === 'traditional' && `of 4` } Entrées { Object.keys(mainItemList).length !== 0 && <span><img src={editIcon.src}/></span> }</h4>
                    <ul>
                        {mainItemList} 
                    </ul>
                </section>      
                ...
                <section className="order-summary--items small-items">
                    <h4 className="bold">{getQuantityTotal(selectedSmallItems)} { activeScheme === 'traditional' && `of 4` } Small Plates { Object.keys(smallItemList).length !== 0 && <span><img src={editIcon.src}/></span>}</h4>
                    <ul>
                        {smallItemList}
                    </ul>
                </section>     
